...
<div class="topbar_inner">
    <a href="//www.duoyi.com/" relid="100000" title="多益网络" target="_blank" class="topbar_logo"><img src="//image.duoyi.com/js/topbar/img/logo.png" alt="多益网络"></a>
    ...
    <div class="topbar_nav"> <a relid="100001" href="//www.duoyi.com/" target="_blank">多益网络</a> <a relid="100002" href="//www.duoyi.com/news/news_4360.shtm" target="_blank">注册帐号</a> <a relid="100003" href="//dygame.duoyi.com/" target="_blank">多益战盟</a>
        <div class="topbar_nav_hr"><span>人才招聘</span>
            <div class="topbar_hr_link"><a relid="100005" href="//hr.duoyi.com/" target="_blank">社会招聘</a><a relid="100004" href="//xz.duoyi.com/" target="_blank">校园招聘</a></div>
...
$(".topbar_inner").on("click","a",function(){
	if($(this).attr("relid")){
		 //window.dy_trace && window.dy_trace(["topbar","link",$(this).attr("relid")+"_"+location.pathname]);
	}
});
...
function initList(){
	...
	$(".topbar_game_list").html('<iframe id="gameRank" name="gameRank" allowTransparency="true" style="background:transparent;" src="' + iu + '" width="515" height="350" frameBorder="0" scrolling="no"></iframe></div>');
	initList = $.noop;
}
